...
fun getCities(): List<City> {
    return listOf(
        ...
        City("фывфывфыв", 51.5085300, -0.1257400),
        City("фыЫВПФЫВАП", 35.6895000, 139.6917100),
        City("ЫВАПФВЫАП", 48.8534100, 2.3488000),
        City("ФЫВАФВАИ", 52.52000659999999, 13.404953999999975),
        City("РиВЧАИЫВАм", 41.9027835, 12.496365500000024),
        City("ФВЫАП", 53.90453979999999, 27.561524400000053),
        City("СтаФЫВАПФЫВАИмбул", 41.0082376, 28.97835889999999),
        City("ЫФВАПФЫВА", 38.9071923, -77.03687070000001),
        City("АПРЬ", 50.4501, 30.523400000000038),
        City("АПН", 55.755826, 37.617299900000035),
        City("ЫВАФЫ-Петербург", 59.9342802, 30.335098600000038),
        City("УЦЙРУР", 55.00835259999999, 82.93573270000002),
        City("КНЦКНОКО", 56.83892609999999, 60.60570250000001),
        City("ФУРЕР Новгород", 56.2965039, 43.936059),
        City("ФВАПФЫВАП", 55.8304307, 49.06608060000008),
        City("АПТВАПТ", 55.1644419, 61.4368432),
        City("ЫВАИПИ", 54.9884804, 73.32423610000001),
        City("ФВПФППФ-на-Дону", 47.2357137, 39.701505),
        City("ФЫВАФЫАФЫВАФЫВА", 54.7387621, 55.972055400000045),
    )
}